...
#from model_archs.rdn import RDN
...
#from model_archs.hat_arch_s import HAT
...
parser.add_argument('--data_dir', type=str, default='H:/cjw_SR/GDFHAT/PMLALLSR/test/')
parser.add_argument('--save_folder', default='H:/cjw_SR/GDFHAT/saved_modelsF/2.resultSave/TTSTALL/', help='Location to save checkpoint models')

parser.add_argument('--model_type', type=str, default='ttst')
#parser.add_argument('--pretrained_sr', default='saved_models/Model_all/remote2/gdfhat_epoch_199.pth', help='sr pretrained base model')
parser.add_argument('--pretrained_sr', default='H:/cjw_SR/GDFHAT/saved_modelsF/1.modeluse/ttst_epoch_100.pth', help='sr pretrained base model')
...
def eval():
    ...
    LR_filename = os.path.join(opt.data_dir, 'LR') + '/' 
    print(LR_filename)
